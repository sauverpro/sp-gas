...
const SingleManagerOrder = ({route}) => {
  ...
  return (
   ...
   {order?.Status=="Delivering" && <FontAwesome name="dot-circle-o" size={20} color="orange" className=""/>}
    ...
    <FontAwesome name="calendar-o" size={20} color="black" style={{fontSize:20, fontWeight:500}} className=""/>
    <Text style={{fontFamily:"poppins_semibold"}} className="text-blacky">Date: </Text>
    <Text style={{fontFamily:"poppins"}} className="text-blacky">{moment(order.createdAt).format('MMM Do YYYY')}</Text>

    </View>
    <View className="flex-row space-x-2 items-center">
    <FontAwesome name="clock-o" size={20} color="black" style={{fontSize:20}} className=""/>
    <Text style={{fontFamily:"poppins_semibold"}} className="text-blacky">Time: </Text>
    <Text style={{fontFamily:"poppins"}} className="text-blacky">{moment(order.createdAt).format('h:mm:ss a') || "date"}</Text>
    </View>
    </View>
    ...
    <Text style={{fontFamily:"poppins_semibold"}} className="text-blacky">Evidence Image:</Text>
     <Image source={{uri: evidence}} className="object-contain w-[80%] h-48 bg-gray-200"/>
    </View>}
...
export default SingleManagerOrder