...
import staMaDashboard from "../stationManagerdashboard2-components/StationManagerDashboard.module.css"
import { GiCancel } from "react-icons/gi";
import { MdDownloading } from "react-icons/md";
import { MdNewReleases } from "react-icons/md";
import { FaCheckCircle } from 'react-icons/fa';

function StationManagerStatusCards() {
  return (
    ...
    <Card className={staMaDashboard.cardContainer}>
      <div className={staMaDashboard.contDiv}>
        ...
        <p>56</p>
        <button className={staMaDashboard.newOrderButton}>new</button>
      </div>
    </Card >
    <Card className={staMaDashboard.cardContainer}>
      <div className={staMaDashboard.contDiv}>
...
export default StationManagerStatusCards
